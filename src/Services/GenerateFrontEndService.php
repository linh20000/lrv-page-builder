...
class GenerateFrontEndService {
    ...
    public function updateBladeStyleFile($new, $old)
    {
    ...
    public function createBladeFile($slug, $html)
    {
    ...
    public function generateStyleSheet($styles, $file_name)
    {
    ...
    public function generateRoute($slug, $route)
    {
        $routes = __DIR__.'./../../routes/frontend.php';
    ...
    public function addControllerMethod($method_name, $slug)
    {
        $controller = __DIR__.'./../Http/Controllers/FrontendController.php';
